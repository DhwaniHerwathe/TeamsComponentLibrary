...
export const DonutChart : React.FC<iDonutChartProps> = ({
	...
	useEffect(()=>{
		...
		const svg = d3.select(donutChart.current)
            .attr('width', 250)
            .attr('height', 250)
    ...
    return (
        <Flex>
            {donutsize === "small" ?
            <Card className="donutChartCard" size="small">
                <CardHeader>
                    <Header className="chartType" as="h3" content="Donut Chart"/>
                </CardHeader>
                <CardBody>
                    <div id='chartArea'>
            ...
            :
            <Card className="donutChartBigCard" size="largest">
                <CardHeader>
                    <Header className="chartType" as="h3" content="Donut Chart"/>
                </CardHeader>
                <CardBody>
