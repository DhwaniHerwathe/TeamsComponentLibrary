    ...
    <Provider theme={teamsTheme}>
      <>
        <Flex className="cardWrapper">
                  <Card className="taskDetailsCard" aria-roledescription="card with image and text">
                      <Card.Header fitted>
                          <Flex className="" space="between">
                              <Image className="learningCourseImage"
                                  src={imageFile}
                                  alt="Course"
                              />
                          </Flex>
                          ...
                          <Flex className="cardBody" space="between">
                              <Flex className="" column>
                                  ...
                                  <Flex className="learningCourseDescription">
                                      <Text content="The essential guide to High Velocity Solutions (HVS).
                                        TABLE OF CONTENTS
                                  ...
                                  <Flex className="learningCourseDurations">
                                      <div className="leaningCourseHours"><Image className="learningCourseHoursImage" src={imageClock} /><Text content="8 hours"/></div>
                                      <div className="learningCourseType"><Image className="learningCourseHoursImage" src={imageMonitor} /><Text className="trainingType" content="Online" /></div>
                                      <div className="leaningCourseDate"><Image className="learningCourseCalanderImage" src={imageCalander} /><Text className="trainingType" content="9/12/2021"/></div>
                                  </Flex>
                              </Flex>
                          </Flex>
                      </Card.Body>
                      <Card.Footer fitted>
                          <Flex className="cardFooter">
                              <a target="_blank" className="customBluebtn">Register</a>
                          </Flex>
                      </Card.Footer>
                  </Card>
        </Flex>
