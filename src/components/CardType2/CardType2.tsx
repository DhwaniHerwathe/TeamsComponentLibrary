                      ...
                      <Card compact aria-roledescription="" size="large">
                          ...
                          <Card.Body>
                              <Flex className="taskNameDetails" gap="gap.small">
                                  ...
                                  <Flex column>
                                      <Text color="grey" size="medium" weight="semibold" content="Mike Ross"/>
                                      <Text color="lightgrey" size="small" content="Test Job"/>
                                  </Flex>
                              </Flex>
                              <Flex className="taskCardBody" vAlign="start">
                                  <List items={list1} />
                                  <div style={{ maxWidth: "9rem" }}><List items={list2} truncateHeader={true} truncateContent={true} /></div>
                                  <List items={list3} />
                              </Flex>
                          </Card.Body>
                          <Card.Footer className="card-footer">
                              <Flex space="between">
                                  ...
                                  <Flex gap="gap.small" vAlign="end">
                                      <Button className="editButton" content="Take Action" primary />
                                  </Flex>
                              </Flex>
                          </Card.Footer>
                      </Card>
